...
function CoursesPage() {
  ...
  // Programmatically position "Artificial Intelligence Course" as the second item (index 1) from top
  const aiIdx = allCourses.findIndex((c) => c.title.toLowerCase().includes("artificial intelligence"));
  if (aiIdx !== -1 && aiIdx !== 1) {
    const [aiCourse] = allCourses.splice(aiIdx, 1);
    allCourses.splice(1, 0, aiCourse);
  }
